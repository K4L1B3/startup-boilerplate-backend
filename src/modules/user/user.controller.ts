...
import { MyLogger } from '../../config/logs/logger.service';
...
export class UserController {
  ...
  async createUser(@Body() userData: userDto): Promise<User> {
    ...
    // const message = await this.i18n.translate("user.created", {
    //   lang: "en",
    // });
    this.logger.info('Usuário criado com sucesso', { userData });
    return result;
    // teria que retornar message, mas para isso precisaria mudar o tipo de retorno da função
    // criando uma interface na qual teria como propriedade por exemplo user e message
  }
